...
@CucumberOptions(tags = {"@TC02_APICategoriesTest"},
        format = {"pretty", "html:target/html_report/TC02_APICategoriesTest/",
                "json:target/cucumber-report/TC02_APICategoriesTest.json"},
        features = {"src/test/resources/features/API_Categories.feature"},
        glue = {"com.ek.test"}
)
@Category({CategoryAPI.class})
public class TC02_APICategoriesTest {
}